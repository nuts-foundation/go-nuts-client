...
type SearchPresentationsParams struct {
	Query *map[string]any `form:"query,omitempty" json:"query,omitempty"`
}
...
type GetServiceActivationResponse struct {
	...
	JSON200      *struct {
		...
		Status *GetServiceActivation200Status `json:"status,omitempty"`
...
type GetServiceActivation200Status string
